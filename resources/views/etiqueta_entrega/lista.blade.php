<x-layout>
    ...
    <x-panel class="flex flex-col pt-8 pb-8" style="height: 550px;">
        ...
        <div class="px-8 flex-1 overflow-auto">
            <Link href="{{ route('etiqueta-nova') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600" modal>+ Nova Etiqueta Entrega</Link>
            <x-splade-table :for="$etiquetas_entrega" />
        </div>
